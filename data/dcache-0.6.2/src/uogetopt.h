...
#ifdef UOGO_SMALL
  /* no longhelp */
#define UOGO_O(s,l,fu,fl,var,val,sh,lh,pa) \
  {s,l,fu,fl,var,val,sh,0,pa}
#else
#define UOGO_O(s,l,fu,fl,var,val,sh,lh,pa) \
  {s,l,fu,fl,var,val,sh,lh,pa}
#endif
...
#ifdef UOGO_SMALL
  /* no long description */
#define UOGO_E(pr,pa,ve,sy,sh,lo,ta,mi,mx,fd,re,out,opts) \
  {pr,pa,ve,sy,sh,0,ta,mi,mx,fd,re,out,opts}
#else
#define UOGO_E(pr,pa,ve,sy,sh,lo,ta,mi,mx,fd,re,out,opts) \
  {pr,pa,ve,sy,sh,lo,ta,mi,mx,fd,re,out,opts}
#endif
